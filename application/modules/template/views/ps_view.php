                    ...
                    <div class="top_right">
                        <div class="top_right_menu">
                            <ul>
                                ...
                                <!--                                    <span class="badge badge color_2">--><?php //echo '2'; ?>
                                <!-- </span> </a>-->
            ...
            <div class="left_nav">
                ...
                <div class="left_nav_slidebar">
                    <ul>
                        ...
                        <li>
                            <a href="javascript:void(0);"> <i class="fa fa-bar-chart "></i>IMMUNIZATION <br>&emsp;&emsp;&ensp;PERFORMANCE<span class="plus"><i
                                    class="fa fa-plus"></i></span> </a>
                            <ul>
                                <li>
                                    <a href="<?php echo site_url('reports/counties'); ?>"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Counties</b> </a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('reports/subcounties'); ?>"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Sub-counties</b> </a>
                                </li>
                            </ul>
                        </li>
                        <li>
