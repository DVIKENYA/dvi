                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo site_url('order/list_orders'); ?>"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Request Stocks</b> </a>
                                </li>
                        ...
                        <li>
                            <a href="javascript:void(0);"> <i class="fa fa-gear"></i>CONFIGURATIONS<span class="plus"><i class="fa fa-plus"></i></span> </a>
