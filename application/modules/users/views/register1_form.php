...
<?php echo form_open('users/register','class="form"');?>
    ...
    <div class="form-section ">
        ...
        echo form_dropdown('user_group', $group, $user_group, 'id="user_group" class="form-control required"');
        echo form_label('Enter Access Level','user_level');
        echo form_error('user_level');
        echo form_dropdown('user_level', $level, $user_level, 'id="user_level" class="form-control required"');
        ?>
      ...
      <div id="base1">
        ...
        echo form_dropdown('national', $nation, $national, 'id="national" class="form-control required"');
        ?>
      </div>
      <div id="base2">
        <?php
