...
$url = 'order/save_forwarded_order/'.$order_id ;
...
<!--          <td> <select name="vaccine" class="form-control vaccine" id="vaccine">
                    ...
                    <td><?php $data=array('name' => 'first_expiry_date','id'=> 'first_expiry_date' , 'class'=>'form-control first_expiry_date_', 'readonly'=>'readonly','value'=> $first_expiry); echo form_input($data);?></td>
                    <td><?php $data=array('name' => 'quantity_dose','id'=> 'quantity_dose', 'class'=>'form-control quantity_dose_', 'readonly'=>'readonly','value'=> $quantity_ordered); echo form_input($data);?></td>
               <?php }?>       
          </tr>
   ...
   <button type="submit" name="submit" id="submit" class="btn btn-sm btn-danger">Forward Order</button>
   <?php 
echo form_close();
